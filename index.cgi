...
# "1.150n"-"1.199n"
my $VER="V.1.151n(nanakochi123456)";
my $tarball="power110406-2.tar.gz";
my $data_update=<<EOM;
<li>2011/4/06 19:00 東京電力　１０日まで計画停電なしに対応</li>
<li>2011/4/06 10:49 東京電力　７日計画停電なしに対応</li>
<li>2011/4/05 19:15 東京電力データを更新。及び、６日計画停電なしに対応</li>
...
<li>2011/4/06 10:49 モバイル向けのHTML出力をわずかに変更した</li>
<li>2011/4/05 19:15 町名を入力しない場合、グループの計画停電時間の一覧を表示するようにした。</li>
<li>2011/4/03 18:00 サブグループを含めた検索を再検証し、実装しなおした。また、area.html、及び area.xml 化をした。</li>
